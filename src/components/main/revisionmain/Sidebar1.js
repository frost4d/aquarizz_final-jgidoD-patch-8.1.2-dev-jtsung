...
import { Box, Flex, Text, Link, Button, Heading, Divider, useDisclosure, Grid, GridItem, Image, Avatar } from "@chakra-ui/react";
                      ...
                      userProfile && (
                        <Flex justify="center" align="center" flexDirection="row">
                          <Avatar
                            ...
                            src={userProfile.profileImage || "/path/to/avatar.jpg"}
                            border="2px solid #e1e1e1" // Example styling to match ProfilePage.js
                            borderRadius="full" // Consistent with ProfilePage.js
                          />
                        </Flex>
                      )
                    )}
      ...
      <Flex direction="column" align="start">
        ...
        >
          <Flex align="center" ml="12px">
            <UserPlus size={20} />
            <Text ml="2" fontSize="lg">Following</Text>
          </Flex>
        </Link>
        <Link
          p="2"
        ...
        >
          <Flex align="center" ml="12px">
            <Users size={20} />
            <Text ml="2" fontSize="lg">Friends</Text>
          </Flex>
        </Link>
        <Link
          p="2"
        ...
        >
          <Flex align="center" ml="12px">
            <ChatIcon size={20} />
            <Text ml="2" fontSize="lg">Message</Text>
          </Flex>
        </Link>
        {/* <Link
          p="2"
