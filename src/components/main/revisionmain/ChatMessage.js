...
const ChatMessage = () => {
  ...
  useEffect(() => {
    if (localVideoRef.current && mediaStream) {
      ...
      console.error("Local video ref or mediaStream is not available.");
    }
  }, [mediaStream]);
  ...
  <ModalContent>
    ...
    <ModalBody>
      <Flex direction="column" align="center">
        <Box as="video" ref={localVideoRef} autoPlay playsInline muted w="100%" h="200px" bg="black" mb={4} />
        <Box as="video" ref={remoteVideoRef} autoPlay playsInline w="100%" h="200px" bg="black" />
      </Flex>
    </ModalBody>
    <ModalFooter>
